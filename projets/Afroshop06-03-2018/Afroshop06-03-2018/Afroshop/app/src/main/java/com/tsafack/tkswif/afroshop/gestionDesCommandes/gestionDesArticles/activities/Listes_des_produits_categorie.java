...
public class Listes_des_produits_categorie extends AppCompatActivity {

    private RecyclerView recyclerView;
    private MyArticlesAdapter adapter = new MyArticlesAdapter(null, null);
   private RecyclerView.LayoutManager LayoutManager;
   private List<ArticleCustom> ListeProduits= new ArrayList<ArticleCustom>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton floatingActionButton = (FloatingActionButton) findViewById(R.id.ajouterproduit_button);
        ...
        recyclerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Listes_des_produits_categorie.this, Page_de_detaille_du_produit.class);
    ...
    private void prepareAlbums() {
        ...
        CategorieArticle categorieArticle = intent.getParcelableExtra(Extra.CATEGORIE);
        GestionArticle gestionArticle = new GestionArticle(this);
        adapter = gestionArticle.listerArticlesCategorie(categorieArticle.getIdCategorieArticle(), recyclerView);

//        ArticleCustom articleCustom = new ArticleCustom("rer", "carottes", "legumes",
//                "bien roujes venant du nord cameroun", 200,
//                100, 1000, "20-4-2018",
//                "KG", "kjshds", "shgddhe",
//                "yvana", 3, false, false,
//                "Centre", "Yaounde", "damas");
//        ArrayList<MediaArticle> images = new ArrayList<MediaArticle>();
//        images.add(new MediaArticle("sjhdhj", "djhsh", "hsadghg", "aus/shdg"));
//        images.add(new MediaArticle("sjhdhj", "djhsh", "hsadghg", "aus/shdg"));
//        images.add(new MediaArticle("sjhdhj", "djhsh", "hsadghg", "aus/shdg"));
//        articleCustom.setImages(images);
//        ListeProduits.add(articleCustom);
//        adapter = new MyArticlesAdapter(Listes_des_produits_categorie.this, ListeProduits);
